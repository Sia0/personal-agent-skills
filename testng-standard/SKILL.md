...
description: For java project that implementing data-driven tests with TestNG DataProviders.
...
## References
Sample implementations in the `references/` directory:
| Guide | Contents |
|---|---|
| [TestNG Implementation Template (AAA Pattern)](references/example-testng-template.md) | TestNG Implementation Sample (AAA Pattern) |

# TestNG Data-Drive Testing
